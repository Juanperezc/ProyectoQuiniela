				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="jumbotron">
							...
							<p>Quiniela para los juegos de la fase de grupos del grupo B
								del mundial, los equipos son Portugar, España, Marruecos,
								Irán las reglas son : - Acertar quien gana 4pts - Puntaje
					...
					<div class="col-md-6">
						<div class="ibox-content">
							...
							<table class="footable table table-stripped" data-page-size="2"
								...
								<tbody>
									<tr class="gradeX">
										<td class="center">Marruecos</td>
										<td class="center">0</td>
									</tr>
									<tr class="gradeC">
										<td class="center">Irán</td>
										<td class="center">0</td>
									</tr>
									<tr class="gradeA">
										<td class="center">Portugal</td>
										<td class="center">0</td>
									</tr>
									<tr class="gradeA">
										<td class="center">España</td>
										<td class="center">0</td>
									</tr>
									<tr class="gradeX">
										<td class="center">Irán</td>
							...
							<div class="row">
								<div class="col-md-6 b-r">
									<form role="form">
										...
										<button class="btn btn-large btn-primary hide"
